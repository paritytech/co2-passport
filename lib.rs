...
mod asset_co2_emissions {
    ...
    mod tests {
        ...
        fn should_blast_with_multiple_emissions_items() {
            ...
            let items_count = 3u8;
            let emissions = new_emissions(1, items_count + 1);
        ...
        fn should_get_emissions_work_properly() {
            ...
            let emissions = new_emissions(1, 3);
        ...
        fn should_reject_zero_emissions_item_in_add_emissions() {
            ...
            let new_emission_item = new_emission(
                e.category,
                e.data_source,
                e.balanced,
                emissions_value_0,
        ...
        fn should_reject_zero_emissions_item_in_transfer() {
            ...
            let new_emission_item_0 = new_emission(
                emissions_category,
                emissions_data_source.clone(),
                emissions_balanced,
                emissions_value_1,
            ...
            let new_emission_item_1 = new_emission(
                emissions_category,
                emissions_data_source.clone(),
                emissions_balanced,
                emissions_value_1,
            ...
            let new_emission_item_2 = new_emission(
                emissions_category,
                emissions_data_source,
                emissions_balanced,
                emissions_value_1,
        ...
        fn should_reject_too_many_chars_in_metadata() {
            ...
            let emissions_balanced = true;
            let emissions_value = 1u128;
            let emissions_item = new_emission(
                emissions_category,
                emissions_data_source,
                emissions_balanced,
                emissions_value,
